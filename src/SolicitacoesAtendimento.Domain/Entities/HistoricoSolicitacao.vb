...
Public Shared Function Criar(solicitacaoId As Integer, statusAnterior As StatusSolicitacao, novoStatus As StatusSolicitacao, observacao As String) As HistoricoSolicitacao
